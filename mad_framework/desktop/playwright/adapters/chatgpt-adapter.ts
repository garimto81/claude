/**
 * Playwright ChatGPT Adapter
 *
 * chat.openai.com 사이트 자동화
 * Issue #17: AdapterResult 타입으로 표준화
 * Playwright Page 기반으로 전환
 */

import type { Page } from 'playwright';
import { PlaywrightBaseLLMAdapter } from './base-adapter';
import type { AdapterResult } from '../../shared/types';

export class PlaywrightChatGPTAdapter extends PlaywrightBaseLLMAdapter {
