...
class TestTextGradOptimizer:
    ...
    def test_analyze_long_prompt(self):
        ...
        assert any(
            g.gradient_type == GradientType.IMPROVE_CONCISENESS for g in gradients
        )
    ...
    def test_analyze_vague_prompt(self):
        ...
        assert any(
            g.gradient_type == GradientType.IMPROVE_SPECIFICITY for g in gradients
        )
...
class TestPromptOptimization:
    ...
    def test_optimize_prompt_with_examples_added(self):
        ...
        if steps:
            assert any(
                GradientType.ADD_EXAMPLES
                in [g.gradient_type for g in s.gradients_applied]
                for s in steps
            )
