...
def test_scenario_1():
    ...
    print(
        f"   Score: {score1['weighted_avg']:.0%} (Grade: {score1['grade']}, Confidence: {score1['confidence']:.0%})"
    )
    ...
    print(
        f"   Score: {score2['weighted_avg']:.0%} (Grade: {score2['grade']}, Confidence: {score2['confidence']:.0%})"
    )
...
def test_scenario_4():
    ...
    score1 = quality.get_score()
    print(
        f"   Score: {score1['weighted_avg']:.0%}, Confidence: {score1['confidence']:.0%}"
    )
    ...
    score2 = quality.get_score()
    print(
        f"   Score: {score2['weighted_avg']:.0%}, Confidence: {score2['confidence']:.0%}"
    )
    ...
    print(
        f"   Score: {score3['weighted_avg']:.0%}, Confidence: {score3['confidence']:.0%}"
    )
    ...
    print(
        f"   Score: {score4['weighted_avg']:.0%}, Confidence: {score4['confidence']:.0%}"
    )
